...
<header class="top-nav">
	<div class="nav-left">
		<a class="nav-brand" href="${DOCS_URL}" target="_blank" aria-label="Puter">
			<img src="${PUTER_MARK}" alt="Puter" height="30" />
		</a>
		<a class="nav-brand-label" href="${DOCS_URL}" target="_blank">
			Puter <span class="labs-badge">Labs</span>
		</a>
	</div>
	<div class="nav-links">
		<a class="nav-link" href="${DOCS_URL}" target="_blank" aria-label="Docs">Docs</a>
		<a class="nav-link" href="${GITHUB_URL}" target="_blank" aria-label="GitHub">
...
<div class="app" id="app" hidden>
	<div class="app-body">
		...
		<div class="status-bar">
			<a class="powered-badge" href="${DOCS_URL}" target="_blank">
		...
		<ol class="dialog-steps">
			<li>
				<span class="step-text">
					<a href="${TERMINAL_URL}" target="_blank">Open a Terminal</a> —
